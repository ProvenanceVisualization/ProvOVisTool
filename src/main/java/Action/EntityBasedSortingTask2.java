...
public class EntityBasedSortingTask2 {
    // Variables
    ...
    public EntityBasedSortingTask2(CyNetworkView view, FilterUtil filter){
        // Initializations
        entityX = 0;
        entityY = 0;
...
//        if(false == cytoVisProject.getMyControlPanel().isBDMOn) {
    ...
    public void relocate(List<CyNode> activities,CyNode entity){
        ...
        networkView.setVisualProperty(NETWORK_SCALE_FACTOR, 0.5);
        networkView.setVisualProperty(NETWORK_CENTER_X_LOCATION, 350);
