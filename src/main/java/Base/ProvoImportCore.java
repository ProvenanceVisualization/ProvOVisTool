...
public class ProvoImportCore extends JPanel {
    ...
    ImportVisualStyleTaskFactory importVisualStyleTaskFactory;
    ...
    public void createFiles(){
        try{
            ...
            filePathStr = "C:\\tmp";
            this.folderFile = new File(filePathStr);
            folderFile.mkdir();
            //this.outFile = new File("/home/erkan/Desktop/csv/out.html");
            this.outFile = new File("C:\\out.txt");
    ...
    public void extractFiles(){
        File edgeFile = new File(filePathStr + "\\edges.csv");
        edgeFile.delete();

        File nodeFile = new File(filePathStr + "\\nodes.csv");
        nodeFile.delete();
...
//        JOptionPane.showMessageDialog(adapter.getCySwingApplication().getJFrame()," whole path --> " + path,
//                "Info!", JOptionPane.INFORMATION_MESSAGE);
    ...
    public void importVisStyleTask(){
        importVisualStyleTaskFactory = new ImportVisualStyleTaskFactory(cytoVisProject);
