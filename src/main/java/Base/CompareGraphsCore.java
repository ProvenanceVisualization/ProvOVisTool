    ...
    public boolean chooseFirstGraphsNode() {
        ...
        if (fileChooser.showOpenDialog(fileChooser) == 0) {
            ...
            if (!file.getName().contains(".csv")) {
                ...
                this.node1FileName = new String();
                this.setNode1FileName(file.getName());
            }
        }

//        JOptionPane.showMessageDialog(adapter.getCySwingApplication().getJFrame(),"node 1 path  "+ node1Path,
...
//        JOptionPane.showMessageDialog(adapter.getCySwingApplication().getJFrame(),"edge 1 path "+ edge1Path,
//                "Info!", JOptionPane.INFORMATION_MESSAGE);
...
//        JOptionPane.showMessageDialog(adapter.getCySwingApplication().getJFrame(),"node 2 path "+ node2Path,
//                "Info!", JOptionPane.INFORMATION_MESSAGE);
        return result;
    }
...
//        JOptionPane.showMessageDialog(adapter.getCySwingApplication().getJFrame(),"edge 2 path "+ edge2Path,
//                "Info!", JOptionPane.INFORMATION_MESSAGE);
    ...
    //TODO: imy
    //Sag click ile hic sectiermeden direk atasin.

    public Integer compareGraphs() {
        Integer result = 1;


//        JOptionPane.showMessageDialog(adapter.getCySwingApplication().getJFrame(),"here in the beginning",
//                "Info!", JOptionPane.INFORMATION_MESSAGE);

//        if(node1Path.isEmpty())
//            node1Path = "C:\\tmp1\\node1.csv";

//        JOptionPane.showMessageDialog(adapter.getCySwingApplication().getJFrame(),"node1Path "+ node1Path,
//                "Info!", JOptionPane.INFORMATION_MESSAGE);

//        if(edge1Path.isEmpty())
//            edge1Path = "C:\\tmp1\\edge1.csv";
//        JOptionPane.showMessageDialog(adapter.getCySwingApplication().getJFrame(),"edge 1 path "+ edge1Path,
//                "Info!", JOptionPane.INFORMATION_MESSAGE);
...
//        JOptionPane.showMessageDialog(adapter.getCySwingApplication().getJFrame(),"node2Path "+ node2Path,
//                "Info!", JOptionPane.INFORMATION_MESSAGE);

//        if(edge2Path.isEmpty())
//            edge2Path = "C:\\tmp1\\edge2.csv";

//        JOptionPane.showMessageDialog(adapter.getCySwingApplication().getJFrame(),"edge2Path "+ edge2Path,
//                "Info!", JOptionPane.INFORMATION_MESSAGE);
...
/*        node1Path = node1FileName;
        node2Path = node2FileName;
        edge1Path = edge1FileName;
        edge2Path = edge2FileName;*/
        ...
        secondGraphsNodes = new JSONArray();
//
//        JOptionPane.showMessageDialog(adapter.getCySwingApplication().getJFrame()," paths --> "+node1Path+node2Path+edge2Path+edge2Path,
//                "Warning!", JOptionPane.INFORMATION_MESSAGE);


        if((node1Path.isEmpty() || node2Path.isEmpty() || edge1Path.isEmpty() || edge2Path.isEmpty()))
        {
            JOptionPane.showMessageDialog(adapter.getCySwingApplication().getJFrame()," Please select all the graph comparison node/edge data",
                    "Warning!", JOptionPane.INFORMATION_MESSAGE);
            result = 0;
        }
        else if(!node1Path.contains("nodes1") || !node2Path.contains("nodes2"))
        {
            JOptionPane.showMessageDialog(adapter.getCySwingApplication().getJFrame()," Please select proper node data->"+node1Path+node2Path,
                    "Warning!", JOptionPane.INFORMATION_MESSAGE);
            result = 0;
        }
        else if(!edge1Path.contains("edges1")||!edge2Path.contains("edges2"))
        {
            JOptionPane.showMessageDialog(adapter.getCySwingApplication().getJFrame()," Please select proper edge data->"+edge2Path+edge1Path,
                    "Warning!", JOptionPane.INFORMATION_MESSAGE);
            result = 0;
        }
        else
...
//            JOptionPane.showMessageDialog(adapter.getCySwingApplication().getJFrame(),"after readGraphs!",
//                    "Warning!", JOptionPane.INFORMATION_MESSAGE);
        }
    ...
    public void findSimilarNodePairsWithSorting() throws IOException {
...
//        try {
//            writer = new FileWriter("C:\\tmp\\checkAttendance.txt");
//        } catch (IOException e) {
//            e.printStackTrace();
//        }
...
//            buffer.newLine();
//
//            buffer.write("algorithm --> " + String.valueOf(algorithm));
//            buffer.newLine();
...
//            buffer.write("Threshols --> "+String.valueOf(THRESHOLD));
//            buffer.newLine();
...
//                    buffer.write("firstNode --> "+((JSONObject) attendanceList.get(i)).get("firstNode").toString());
//                    buffer.newLine();
//                    buffer.write("secondNode --> "+((JSONObject) attendanceList.get(i)).get("secondNode").toString());
//                    buffer.newLine();
//                    buffer.write(" similarity is --> "+Double.parseDouble(((JSONObject) attendanceList.get(i)).get("attendance").toString()));
//                    buffer.newLine();
...
//        writer.close();
                    ...
                    for(node2index=0; node2index<s2; node2index++){
                        ...
                        if(algorithm == 2){
                            ...
                            for(String property:edgePropertyList){
                                if(property.equals("interaction")){
                                    if(!findEdgeProperty(node1, adjacentOfFirstNode, property, isFirstForBigger).equals(findEdgeProperty(node2, adjacentOfSecondNode, property, isFirstForLower))){
                                        JOptionPane.showMessageDialog(adapter.getCySwingApplication().getJFrame(), " here 1 isSimilar false ",
                                                "Warning!", JOptionPane.INFORMATION_MESSAGE);
                            ...
                            for(String property:nodePropertyList){
                                if(property.equals("nodeType")){
                                    if(!findNodeProperty(adjacentOfFirstNode, property, isFirstForBigger).equals(findNodeProperty(adjacentOfSecondNode, property, isFirstForLower))){
                                        JOptionPane.showMessageDialog(adapter.getCySwingApplication().getJFrame(), " here 2 isSimilar false ",
                                                "Warning!", JOptionPane.INFORMATION_MESSAGE);
                                        nodepair.put("isSimilar", false);
                                        break;
                                    }
                ...
                if(algorithm == 2){
                    ...
                    for(String property:nodePropertyList){
                        if(property.equals("nodeType")){
                            if(!findNodeProperty(node1, property, isFirstForBigger)
                                    .equals(findNodeProperty(node2, property, isFirstForLower))){
                                JOptionPane.showMessageDialog(adapter.getCySwingApplication().getJFrame(), " here 3 isSimilar false ",
                                        "Warning!", JOptionPane.INFORMATION_MESSAGE);
                                nodepair.put("isSimilar", false);
                                break;
                            }
                    ...
                    if(incidentNodesForNode1.size() != incidentNodesForNode2.size()){
                        JOptionPane.showMessageDialog(adapter.getCySwingApplication().getJFrame(), " here 4 isSimilar1  false ",
                                "Warning!", JOptionPane.INFORMATION_MESSAGE);
    ...
    public void createAttendanceList() throws IOException {
        Integer     i;
        Integer     j;
        Integer     node1index;
        Integer     node2index;
        ...
        Integer counter = 0;
        ArrayList<CyNode> pairNodes = new ArrayList<>();

//        FileWriter writer = new FileWriter("C:\\tmp\\algo.txt");
//        JOptionPane.showMessageDialog(adapter.getCySwingApplication().getJFrame(),"file opened ",
//                "file mile", JOptionPane.INFORMATION_MESSAGE);
//        try (BufferedWriter buffer = new BufferedWriter(writer)) {
//            buffer.write("Welcome to javaTpoint.");
...
//            buffer.newLine();
            ...
            //imy
            if (1 == algorithm) {
//                JOptionPane.showMessageDialog(adapter.getCySwingApplication().getJFrame(), "in algo 1 gr1 size",
//                        "file mile", JOptionPane.INFORMATION_MESSAGE);

                ArrayList<String> firstGraph = cytoVisProject.getMyControlPanel().drawComparedGraphs.firstGraphNames;

                ArrayList<String> secondGraph = cytoVisProject.getMyControlPanel().drawComparedGraphs.secondGraphNames;

                for (int first = 0; first < firstGraph.size(); first++) {
                    String firstStr = firstGraph.get(first);

                    for (int second = 0; second < secondGraph.size(); second++) {
                        JSONObject nodepair = new JSONObject();
                        String secondStr = secondGraph.get(second);

                        if (secondStr.contains(firstStr)) {
//                       pairNodes.add(cytoVisProject.getMyControlPanel().drawComparedGraphs.nodeHashMap.get(str));
//                       pairNodes.add(cytoVisProject.getMyControlPanel().drawComparedGraphs.nodeHashMap.get(str2));


//                            if (firstStr.equals("activity6"))
//                                JOptionPane.showMessageDialog(adapter.getCySwingApplication().getJFrame(), " pair with --> " + secondStr,
//                                        "file mile", JOptionPane.INFORMATION_MESSAGE);

                            nodepair.put("firstNode", firstStr);
                            nodepair.put("secondNode", secondStr);
                            nodepair.put("isSimilar", true);
...
//                JOptionPane.showMessageDialog(adapter.getCySwingApplication().getJFrame(), "in algo end attendance size --> " + attendanceList.size(),
//                        "file mile", JOptionPane.INFORMATION_MESSAGE);
            } else {

//                JOptionPane.showMessageDialog(adapter.getCySwingApplication().getJFrame(), "in algo 2 gr1 size",
//                        "file mile", JOptionPane.INFORMATION_MESSAGE);
...
//                        buffer.write("first Node --> "+((JSONObject) firstGraphsNodes.get(i)).get("nodeID").toString());
//                        buffer.write("  second Node --> "+((JSONObject) secondGraphsNodes.get(i)).get("nodeID").toString());
//                        buffer.newLine();
...
//                                JOptionPane.showMessageDialog(adapter.getCySwingApplication().getJFrame(), " here 5 isSimilar false ",
//                                        "Warning!", JOptionPane.INFORMATION_MESSAGE);
...
//                                buffer.write("adjacentOfFirstNode --> "+adjacentOfFirstNode);
//                                buffer.newLine();
...
//                                    buffer.write("-----> adjacentOfSecondNode --> "+adjacentOfFirstNode);
//                                    buffer.newLine();
...
//                                        buffer.write("--------> tempSimilarity 1 --> "+String.valueOf(tempSimilarity));
//                                        buffer.newLine();
...
//                                        buffer.write("--------> tempSimilarity2 --> "+String.valueOf(tempSimilarity));
//                                        buffer.newLine();
                                        ...
                                        for (String property : edgePropertyList) {
                                            if (property.equals("edgeType")) {
                                                if (!findEdgeProperty(node1, adjacentOfFirstNode, property, isFirstForBigger).equals(findEdgeProperty(node2, adjacentOfSecondNode, property, isFirstForLower))) {
                                                    nodepair.put("isSimilar", false);
                                                    JOptionPane.showMessageDialog(adapter.getCySwingApplication().getJFrame(), " here 6 isSimilar false ",
                                                            "Warning!", JOptionPane.INFORMATION_MESSAGE);
                                                } else {
                                                    nodepair.put("isSimilar", true);
                                                }
                                        ...
                                        for (String property : nodePropertyList) {
                                            if (property.equals("nodeType")) {
                                                if (!findNodeProperty(adjacentOfFirstNode, property, isFirstForBigger).equals(findNodeProperty(adjacentOfSecondNode, property, isFirstForLower))) {
                                                    String str1 = nodepair.get("firstNode").toString();
                                                    String str2 = nodepair.get("secondNode").toString();
                                                    String str3 = findNodeProperty(adjacentOfFirstNode, property, isFirstForBigger);
                                                    String str4 = findNodeProperty(adjacentOfSecondNode, property, isFirstForLower);
//                                            JOptionPane.showMessageDialog(adapter.getCySwingApplication().getJFrame(), " here 7 nodePairs --> 1 & 2"+str1+" "+str2+"benzemeyen ->"+
//                                                    str3+"ile "+str4+"adj1 ->"+adjacentOfFirstNode+" adj2"+adjacentOfSecondNode,
//                                                    "Warning!", JOptionPane.INFORMATION_MESSAGE);
                                                    nodepair.put("isSimilar", false);
                                                    break;
                                                }
                                ...
                                for (String property : nodePropertyList) {
                                    if (property.equals("nodeType")) {
                                        if (!findNodeProperty(node1, property, isFirstForBigger)
                                            ...
                                            String str1 = nodepair.get("firstNode").toString();
                                            String str2 = nodepair.get("secondNode").toString();
//                                    JOptionPane.showMessageDialog(adapter.getCySwingApplication().getJFrame(), " here 8 nodePairs --> prop "+property+
//                                                    "1 & 2"+str1+" "+str2,
//                                            "Warning!", JOptionPane.INFORMATION_MESSAGE);
                                            nodepair.put("isSimilar", false);
                                            break;
...
//                            String str1 = nodepair.get("firstNode").toString();
//                            String str2 = nodepair.get("secondNode").toString();
//                            JOptionPane.showMessageDialog(adapter.getCySwingApplication().getJFrame(), " here 9 nodePairs --> 1 & 2"+str1+" "+str2,
//                                    "Warning!", JOptionPane.INFORMATION_MESSAGE);
//                            nodepair.put("isSimilar", false);
//                        }
                            }
...
//            JOptionPane.showMessageDialog(adapter.getCySwingApplication().getJFrame(),"in readFile 1 n1--> "+ node1Path,
//                    "Warning!", JOptionPane.INFORMATION_MESSAGE);
        readFile(edge1Path,2);

//            JOptionPane.showMessageDialog(adapter.getCySwingApplication().getJFrame(),"in readFile 2 e1 --> "+ edge1Path,
//                    "Warning!", JOptionPane.INFORMATION_MESSAGE);
        readFile(node2Path,3);

//            JOptionPane.showMessageDialog(adapter.getCySwingApplication().getJFrame(),"in readFile 3 --> "+ node2Path,
//                    "Warning!", JOptionPane.INFORMATION_MESSAGE);
        readFile(edge2Path,4);

//            JOptionPane.showMessageDialog(adapter.getCySwingApplication().getJFrame(),"in readFile 4 --> "+edge2Path,
//                    "Warning!", JOptionPane.INFORMATION_MESSAGE);
...
//            JOptionPane.showMessageDialog(adapter.getCySwingApplication().getJFrame(),"in readFile file pointer header --> "+String.valueOf(filePointer),
//                    "Warning!", JOptionPane.INFORMATION_MESSAGE);
...
//                JOptionPane.showMessageDialog(adapter.getCySwingApplication().getJFrame(),"in readFile file pointer rows --> "+String.valueOf(filePointer),
//                        "Warning!", JOptionPane.INFORMATION_MESSAGE);
...
//            JOptionPane.showMessageDialog(adapter.getCySwingApplication().getJFrame(),"in addJSON firstGraphsNodes --> "+String.valueOf(this.firstGraphsNodes.size()),
//                    "Warning!", JOptionPane.INFORMATION_MESSAGE);

        }else if(filePointer == 2){
            this.firstGraphsEdges.add(data);
//            JOptionPane.showMessageDialog(adapter.getCySwingApplication().getJFrame(),"in addJSON firstGraphsEdges --> "+String.valueOf(this.firstGraphsEdges.size()),
//                    "Warning!", JOptionPane.INFORMATION_MESSAGE);

        }else if(filePointer == 3){
            this.secondGraphsNodes.add(data);
//            JOptionPane.showMessageDialog(adapter.getCySwingApplication().getJFrame(),"in addJSON secondGraphsNodes --> "+String.valueOf(this.secondGraphsNodes.size()),
//                    "Warning!", JOptionPane.INFORMATION_MESSAGE);

        }else if(filePointer == 4){
            this.secondGraphsEdges.add(data);
//            JOptionPane.showMessageDialog(adapter.getCySwingApplication().getJFrame(),"in addJSON secondGraphsEdges --> "+String.valueOf(this.secondGraphsEdges.size()),
//                    "Warning!", JOptionPane.INFORMATION_MESSAGE);
        }
    }
